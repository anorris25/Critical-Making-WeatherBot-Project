...
const char* ssid = "WIRELESS-PITTNET";         //  YOUR WIFI SSID / NAME
...
String serverPath = "http://api.openweathermap.org/data/3.0/onecall?lat=40.4443&lon=-79.9532&units=metric&exclude=minutely&appid={Your-API-Key}";  // Your API call made up as follows: http://api.openweathermap.org/data/2.5/onecall?lat={latitude}}&lon=-{longitude}}&units=metric&exclude=minutely&appid={Your-API-Key}
